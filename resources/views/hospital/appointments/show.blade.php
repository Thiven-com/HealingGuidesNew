        ...
        <div class="page-header">
            ...
            <div class="add-item d-flex">
                <div class="page-title">
                    ...
                    <h6>{{ $appointment->appointment_no }}</h6>
                </div>
            </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <strong>
                                        {{ $appointment->meeting_provider
                                            ? ucfirst($appointment->meeting_provider)
                                            : '-' }}
                                    </strong>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <strong>
                                        {{ $appointment->meeting_status
                                            ? ucfirst($appointment->meeting_status)
                                            : '-' }}
                                    </strong>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            ₹{{ number_format(
                                                (float) ($appointment->consultation_fee ?? 0),
                                                2
                                            ) }}
                                    ...
                                    <tr class="border-top">
                                        ...
                                        <td class="text-end">
                                            ...
                                            <h5 class="mb-0 text-primary">
                                                ...
                                                ₹{{ number_format(
                                                    (float) ($appointment->total_amount ?? 0),
                                                    2
                                                ) }}
    ...
    document
        ...
        .forEach(function (button) {
            ...
            button.addEventListener('click', function () {
                ...
                let message = 'Update appointment status?';
                ...
                if (status === 'confirmed') {
                    ...
                    message = 'Start this appointment?';
                }

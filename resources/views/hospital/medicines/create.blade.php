        ...
        <div class="content">
            ...
            <div class="page-header">
                ...
                <div class="page-title">
                    ...
                    <h6>Create a new hospital medicine</h6>
            ...
            <form method="POST" action="{{ route('hospital.medicines.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="medicine_type"
                                    ...
                                    <option value="Tablet" {{ old('medicine_type') == 'Tablet' ? 'selected' : '' }}>

                                        Tablet

                                    </option>

                                    <option value="Capsule" {{ old('medicine_type') == 'Capsule' ? 'selected' : '' }}>

                                        Capsule

                                    </option>

                                    <option value="Syrup" {{ old('medicine_type') == 'Syrup' ? 'selected' : '' }}>

                                        Syrup

                                    </option>

                                    <option value="Injection" {{ old('medicine_type') == 'Injection' ? 'selected' : '' }}>

                                        Injection

                                    </option>

                                    <option value="Cream" {{ old('medicine_type') == 'Cream' ? 'selected' : '' }}>

                                        Cream

                                    </option>

                                    <option value="Ointment" {{ old('medicine_type') == 'Ointment' ? 'selected' : '' }}>

                                        Ointment

                                    </option>

                                    <option value="Drops" {{ old('medicine_type') == 'Drops' ? 'selected' : '' }}>

                                        Drops

                                    </option>

                                    <option value="Powder" {{ old('medicine_type') == 'Powder' ? 'selected' : '' }}>

                                        Powder

                                    </option>

                                    <option value="Other" {{ old('medicine_type') == 'Other' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="pack_size" value="{{ old('pack_size') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" name="image" id="medicineImage"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="mrp" value="{{ old('mrp') }}"
                                        class="form-control @error('mrp') is-invalid @enderror" min="0" step="0.01"
                                        placeholder="0.00">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="selling_price" value="{{ old('selling_price') }}"
                                        class="form-control @error('selling_price') is-invalid @enderror" min="0"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="composition" rows="4"
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="side_effects" rows="4"
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="storage_instructions" rows="4"

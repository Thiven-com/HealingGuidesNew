        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @elseif($status === 'ready')
                    ...
                    <form method="POST"
                          action="{{ route(
                              'admin.medicine-orders.dispatch'
                          ) }}">

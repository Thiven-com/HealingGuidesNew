        ...
        <div class="content">
            ...
            <div class="page-header">
                ...
                <div class="page-title">
                    ...
                    <h6>Create New Ambulance Type</h6>
            ...
            <form action="{{ route('admin.ambulance-types.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" id="ambulance_type_name" name="ambulance_type_name" class="form-control"
                                    value="{{ old('ambulance_type_name') }}" placeholder="Enter Ambulance Type Name">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <textarea name="description" rows="5" class="form-control"
                                    placeholder="Enter Ambulance Type Description">{{ old('description') }}</textarea>
